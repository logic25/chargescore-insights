...
import type { SiteAnalysis, PropertyType, ElectricalService } from '@/types/chargeRank';
import { PROPERTY_TYPE_LABELS, ELECTRICAL_SERVICE_LABELS } from '@/types/chargeRank';
